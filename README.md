...
- Press `Enter` without entering anything in the command line to advance the simulation foward one step, or hold down the the `Enter` key to to allow the simulation to progress
