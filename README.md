...
- "fr" This command will display the current fire rate (The rate at which any tree will spontaneously catch fire) and offer the opportunity enter a new value for the fire rate. The default fire rate is 0.00003.
